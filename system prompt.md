...
COLORS: {
primary_color: '#0068B7', text_primary: '#333333', background_white: '#FFFFFF',
...
LOGOS: {
header: 'https://www.ntt-west.co.jp/cmn3/img/logo_nttwest.svg',
closing: 'https://www.ntt-west.co.jp/cmn3/img/logo_nttwest.svg'
},
...
function setPrimaryColor() {
  ...
  const currentValue = props.getProperty('primaryColor') || '#0068B7';
  
  const result = ui.prompt(
    'プライマリカラー設定',
    `カラーコードを入力してください（例: #0068B7）\n現在値: ${currentValue}\n\n空欄で既定値にリセットされます。`,
